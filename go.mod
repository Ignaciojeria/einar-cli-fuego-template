...
require (
	...
	github.com/Ignaciojeria/einar-contracts v1.4.0
	...
	github.com/openziti/zrok v0.4.46
...
require (
	...
	github.com/openziti/transport/v2 v2.0.147 // indirect
